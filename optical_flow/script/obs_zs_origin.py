...
class Px4Controller:
    ...
    def sphere_control(self):
        obj_msg = Obj()
        # sphere_msg = Obj()
        obj_msg.id = ID_UAV  # ID_Tong[nums - 1]
        obj_msg.type = Type_UAV  # 99
        obj_msg.position.x = Pos_UAV[0]
        obj_msg.position.y = Pos_UAV[1]
        obj_msg.position.z = Pos_UAV[2]
