...
class Assemble:
    ...
    def __init__(self, param_id):
        ...
        self.OF_cmd_sub = rospy.Subscriber('OF_cmd', TwistStamped, self.OF_cmd_callback)
    ...
    def begin_task(self):
        ...
        while not rospy.is_shutdown():
            if True:
                self.vel_pub.publish(self.of_cmd)
            elif self.dj_action.dj == True:
