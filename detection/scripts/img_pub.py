...
def infrared_image_callback(data):
    global is_show_rgb, is_show_hsv, img_pos
    # define picture to_down' coefficient of ratio
...
if __name__ == '__main__':
    ...
    bridge = CvBridge()
    if is_show_rgb:
        rospy.Subscriber('/rflysim/sensor0/img_rgb', Image, rgb_image_callback)
    rospy.Subscriber('/rflysim/sensor1/img_infrared', Image, infrared_image_callback)
