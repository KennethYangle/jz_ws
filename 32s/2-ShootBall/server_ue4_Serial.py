...
# This demo needs to use Pixhawk hardware to perform HITL simulation
# Please plugin Pixhawk and run client_ue4_HITL.bat to start simulation
# This demo needs to use Radio telemetry module to connect to Pixhawk's TELEM port
# Then Use the '/dev/ttyUSB0:57600' (replace with your own port name) to connect
